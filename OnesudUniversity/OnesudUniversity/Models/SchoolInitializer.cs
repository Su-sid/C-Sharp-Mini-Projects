...
using OnesudUniversity.Data;

namespace OnesudUniversity.Models
{
    public static class SchoolInitializer
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            {
                // Look for any Student, Enrollment and Course.
                if (context.Student.Any() && context.Enrollment.Any() && context.Course.Any())
                {
